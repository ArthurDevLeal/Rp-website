...
export const products: Array<Products> = [
  {
    id: "teste",
    name: "teste",
    bannerId: "https://www.firstbenefits.org/wp-content/uploads/2017/10/placeholder.png",
    category: "teste",
    discount: 10,
    price: 10,
  },
...
const navData = [
  ...
  { Icon: FaUsers, name: "Corp/Fac", target: "corp-fac", isActive: true },
];
export default function CorpFac() {
